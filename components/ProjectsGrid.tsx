          ...
          return (
            ...
            >
              {isNda ? (
                ...
                >
                  <AsciiNoise />
                  <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,color-mix(in_oklab,var(--background)_62%,transparent)_0%,transparent_72%)]" />
                  <h3 className="pointer-events-none relative z-10 max-w-[16ch] px-6 text-center text-[22px] leading-tight tracking-tight text-foreground sm:text-[24px]">
                    {ndaTitle}
                  </h3>
                </div>
              ) : (
