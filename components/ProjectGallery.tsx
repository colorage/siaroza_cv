...
export function ProjectGallery({ images, locale, label }: Props) {
  ...
  return (
    <section aria-label={label} className="animate-fade-up-delay mt-10">
      <div
        tabIndex={0}
        className="project-gallery overflow-x-auto overscroll-x-contain snap-x snap-proximity focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-accent"
      >
